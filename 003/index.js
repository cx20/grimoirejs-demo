// forked from cx20's "[WebGL] Grimoire.js で地球を表示させてみるテスト" http://jsdo.it/cx20/Iwed
// forked from cx20's "[WebGL] Grimoire.js でサッカーボールを表示させてみるテスト" http://jsdo.it/cx20/qgAL
