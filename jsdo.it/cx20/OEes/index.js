...
gr(function() {
    ...
    const timer = setInterval(function() {
        var image = dataSet[Math.floor(Math.random() * 90)].image;
        console.log(image);
        const n = scene.addChildByName("rigid-cube", {
            //material: ["#red", "#green", "#blue"][Math.floor(Math.random() * 3)],
            //color: getRandomColor(),
            //texture:"http://jsdo-static-contents.s3.amazonaws.com/images/capture/m/j/C/mjC6_100.jpg",
            //texture:"https://github.com/cx20/gltf-test/blob/master/sampleModels/BoxTextured/glTF/CesiumLogoFlat.png",
            //texture:"https://github.com/cx20/gltf-test/blob/master/sampleModels/BoxTextured/glTF/CesiumLogoFlat.png",
            //texture:"https://raw.githubusercontent.com/cx20/jsdo-static-contents/719ce319/images/03xg_100.jpg",
            texture: image,
